...
export const vi: TranslationMap = {
  ...
  channels: {
    ...
    whatsapp: {
      ...
      logoutNotCleared:
        "Không có phiên WhatsApp nào được lưu bị xóa. Có thể phiên đã không tồn tại, hoặc thư mục xác thực của nó cần được dọn dẹp thủ công.",
    },
  ...
  quickSettings: {
    ...
    personal: {
      ...
      profileHint: "JPEG, PNG hoặc WebP. Hình ảnh được cắt ở giữa và thay đổi kích thước về 512px.",
      profileLoadFailed: "Không thể tải hồ sơ của bạn.",
      profileSaveFailed: "Không thể lưu hồ sơ của bạn.",
      avatarInvalid: "Chọn hình ảnh JPEG, PNG hoặc WebP hợp lệ.",
  ...
  configView: {
    ...
    notifications: {
      ...
      nativeHint: "Thông báo được hiển thị tự nhiên bởi ứng dụng OpenClaw trên máy Mac này.",
  ...
  subtitles: {
    ...
    labs: "Tính năng agent và công cụ thử nghiệm.",
    ...
    security: "Xác thực Gateway, chính sách exec, hồ sơ công cụ và phê duyệt.",
  ...
  custodian: {
    ...
    newAgent: "Agent mới",
    hatchDraft: "Thức dậy đi, bạn của tôi!",
    ...
    nudge: {
      configReload: "Việc tải lại cấu hình đã dừng — hỏi tôi chuyện gì đã xảy ra",
      channelAuth: "Xác thực {channel} bị suy giảm — hỏi tôi chuyện gì đã xảy ra",
      channelDisconnected: "{channel} vừa bị ngắt kết nối — hỏi tôi chuyện gì đã xảy ra",
      channelDegraded: "{channel} đang bị suy giảm — hỏi tôi chuyện gì đã xảy ra",
  ...
  mcpServers: {
    ...
    nameTaken: "Máy chủ MCP tên “{name}” đã tồn tại.",
    ...
    connectRequired: "Kết nối tới gateway để thay đổi máy chủ MCP.",
    adminRequired: "Thay đổi máy chủ MCP yêu cầu quyền operator.admin.",
    enable: "Bật",
    disable: "Tắt",
  ...
  labsPage: {
    intro:
      "Labs chứa các khả năng thử nghiệm có thể thay đổi, hỏng hoặc biến mất giữa các bản phát hành.",
    sectionTitle: "Tính năng thử nghiệm",
    sectionDescription:
      "Các thay đổi được lưu ngay lập tức và áp dụng cho các lần chạy agent sau này.",
    documentation: "Tài liệu",
    restartRequired: "Cần khởi động lại Gateway.",
    saveErrorTitle: "Không thể cập nhật tính năng",
    saveFailed: "Không thể lưu thiết lập tính năng.",
    codeMode: {
      title: "Code Mode",
      description:
        "Cho phép agent kết hợp các công cụ trong quy trình JavaScript gọn nhẹ, được cách ly.",
    },
    swarm: {
      title: "Swarm",
  ...
  appsPage: {
    ...
    badgeBundledIos: "Đã bao gồm trong ứng dụng iOS",
  ...
  profilePage: {
    ...
    identity: {
      ...
      avatar: "Ảnh đại diện",
      avatarDescription:
        "PNG, JPEG hoặc WebP. Hình ảnh được thay đổi kích thước xuống 256 × 256 hoặc nhỏ hơn.",
      ...
      avatarErrors: {
        ...
        sourceTooLarge: "Chọn hình ảnh có dung lượng 10 MB trở xuống.",
  ...
  board: {
    ...
    emptyHint: "Tác nhân của bạn có thể ghim widget vào đây — thử yêu cầu một thẻ trạng thái.",
    ...
    widget: {
      ...
      rejectedDetail: "Widget này vẫn không hoạt động cho đến khi được gỡ bỏ hoặc thay thế.",
      ...
      actionErrorDetail: "Bảng điều khiển đã giữ nguyên trạng thái widget trước đó.",
  ...
  chat: {
    ...
    board: {
      ...
      dockLeft: "Ghim trò chuyện bên trái",
      dockRight: "Ghim trò chuyện bên phải",
      dockBottom: "Ghim trò chuyện bên dưới",
    ...
    messages: {
      ...
      forkUnavailable: "Không thể phân nhánh khi tác nhân đang làm việc",
    ...
    composer: {
      ...
      microphoneAppliesNextSession: "Các thay đổi sẽ áp dụng khi bạn bắt đầu phiên Talk tiếp theo.",
      ...
      dictationBrowserAudioUnsupported:
        "Trình duyệt này không thể thu âm thanh đọc chính tả ở 8 kHz.",
      ...
      dictationFinalizationTimedOut:
        "Đọc chính tả đã dừng trước khi bản ghi một phần cuối cùng được hoàn tất.",
