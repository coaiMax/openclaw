...
export const id: TranslationMap = {
  ...
  channels: {
    ...
    whatsapp: {
      ...
      loggedOut: "Keluar.",
      logoutNotCleared:
        "Tidak ada sesi WhatsApp tersimpan yang dihapus. Mungkin sudah tidak ada, atau direktori autentikasinya mungkin memerlukan pembersihan manual.",
    },
  ...
  sessionsView: {
    ...
    dashboardAvailable: "Dashboard tersedia",
    approvalNeeded: "Perlu persetujuan",
  ...
  quickSettings: {
    ...
    personal: {
      ...
      uploading: "Memproses…",
      profileHint:
        "JPEG, PNG, atau WebP. Gambar dipotong di tengah dan diubah ukurannya menjadi 512px.",
  ...
  configView: {
    ...
    notifications: {
      ...
      openSystemSettings: "Buka System Settings",
      blockedHint:
    ...
    sidebarPrefs: {
      title: "Bilah Samping",
      hint: "Pilih apa yang ditampilkan saat sesi sedang berjalan.",
  ...
  custodian: {
    ...
    subtitleCaretaker: "Penyiapan dan perawatan sistem.",
    ...
    sessionRestarted:
      "{error} OpenClaw memulai sesi baru; pesan sebelumnya tetap tersimpan untuk konteks.",
    ...
    history: {
      ...
      changedPaths: "Jalur yang diubah ({count})",
  ...
  labsPage: {
    ...
    sectionDescription: "Perubahan langsung disimpan dan berlaku untuk proses agen berikutnya.",
    documentation: "Dokumentasi",
    restartRequired: "Diperlukan mulai ulang Gateway.",
  ...
  appsPage: {
    ...
    cards: {
      ios: {
        title: "iPhone",
        desc: "Chat, bicara, setujui tindakan, dan bagikan ke OpenClaw dari iOS.",
      },
      android: {
        title: "Android",
      ...
      plugins: {
        ...
        desc: "Perluas OpenClaw dengan channel, tools, dan skills dari komunitas.",
      },
    },
  },
  presence: {
  ...
  board: {
    ...
    moreTabs: "Lebih banyak tab dasbor",
    gridLabel: "Widget dasbor",
    emptyTitle: "Papan yang bersih, siap untuk bekerja",
    ...
    widget: {
      ...
      frameAuthorizationFailed: "Otorisasi widget gagal setelah beberapa kali upaya penyegaran.",
      errorTitle: "Widget ini tidak dapat dimuat",
      errorDetail: "Masalah ini hanya terjadi pada kartu ini.",
  ...
  chat: {
    ...
    sessionHeader: {
      ...
      branchSwitchUnavailable: "Pengalihan cabang tidak tersedia saat agen sedang bekerja.",
      branchSwitchRequiresAdmin: "Pengalihan cabang memerlukan akses admin operator.",
    ...
    board: {
      ...
      dockLeft: "Dok chat di kiri",
      dockRight: "Dok chat di kanan",
      dockBottom: "Dok chat di bawah",
      dockHidden: "Sembunyikan chat",
      resizeDock: "Ubah ukuran dok chat",
      reopenChat: "Tampilkan chat",
      defaultTab: "Utama",
      mockPlaceholder: "Seam tampilan board · {tabs} tab · {widgets} widget",
      ...
      resetDescription: "Konteks percakapan diatur ulang. Dasbor Anda tetap.",
    },
    catalog: {
    ...
    modelControls: {
      ...
      usingDefault: "Menggunakan default dari Settings",
    ...
    composer: {
      ...
      holdToRecordSettingDescription:
        "Tahan tombol mikrofon komposer, bicara, lalu lepaskan untuk menyisipkan teks tanpa mengirim.",
      dictationAudioUnsupported: "Gateway mengembalikan format audio dikte yang tidak didukung.",
      dictationBrowserAudioUnsupported:
        "Peramban ini tidak dapat menangkap audio dikte pada 8 kHz.",
      ...
      dictationFinalizationTimedOut:
        "Dikte dihentikan sebelum transkrip parsial terakhir dapat difinalisasi.",
