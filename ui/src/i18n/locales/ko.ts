...
export const ko: TranslationMap = {
  ...
  channels: {
    ...
    whatsapp: {
      ...
      loggedOut: "로그아웃되었습니다.",
      logoutNotCleared:
        "삭제된 WhatsApp 세션이 없습니다. 이미 없거나 인증 디렉터리를 수동으로 정리해야 할 수 있습니다.",
    },
  ...
  sessionsView: {
    ...
    sessionsArchived: "{count}개의 스레드를 보관함",
    ...
    invalidEmojiIcon: "이모지를 하나만 입력하세요.",
    removeIcon: "아이콘 제거",
  ...
  quickSettings: {
    ...
    personal: {
      ...
      uploading: "처리 중…",
      profileHint:
        "JPEG, PNG 또는 WebP. 이미지는 가운데를 기준으로 잘리고 512px로 크기가 조정됩니다.",
  ...
  configView: {
    ...
    notifications: {
      ...
      nativeHint: "이 Mac의 OpenClaw 앱에서 알림이 기본적으로 표시됩니다.",
  ...
  subtitles: {
    ...
    apps: "휴대폰, 시계, 데스크톱, 브라우저용 컴패니언 앱입니다.",
    ...
    notifications: "게이트웨이의 브라우저 푸시 알림.",
    security: "Gateway 인증, 실행 정책, 도구 프로필 및 승인.",
    advanced: "나머지 모든 설정 섹션과 원시 파일 편집기.",
    debug: "스냅샷, 이벤트, RPC.",
    logs: "실시간 Gateway 로그.",
  ...
  custodian: {
    ...
    sessionRestarted:
      "{error} OpenClaw가 새 세션을 시작했습니다. 이전 메시지는 컨텍스트를 위해 유지됩니다.",
    ...
    nudge: {
      ...
      channelDisconnected: "{channel} 연결이 방금 끊겼습니다 — 무슨 일인지 물어보세요",
  ...
  mcpServers: {
    ...
    adminRequired: "MCP 서버 변경에는 operator.admin 권한이 필요합니다.",
    enable: "활성화",
    disable: "비활성화",
    removeNamed: "{name} 제거",
    working: "작업 중…",
  ...
  mcpPage: {
    connectorsLink: "플러그인 페이지에서 원클릭 커넥터를 살펴보세요.",
    servers: "서버",
    oauth: "OAuth",
    filtered: "필터링됨",
  ...
  labsPage: {
    ...
    codeMode: {
      title: "Code Mode",
      description:
        "에이전트가 간결하고 샌드박스화된 JavaScript 워크플로에서 도구를 조합할 수 있게 합니다.",
    },
    swarm: {
      title: "Swarm",
      description: "Code Mode가 서브에이전트 그룹을 병렬로 오케스트레이션하도록 합니다.",
      empty: "활성 스웜이 없습니다.",
    },
  },
  aboutPage: {
  ...
  appsPage: {
    heroTitle: "OpenClaw를 어디서나",
    heroTagline: "휴대폰, 시계, 데스크톱, 브라우저용 동반 앱과 에이전트 기능을 확장하는 플러그인.",
    sectionMobile: "휴대폰에서",
    ...
    cards: {
      ...
      macos: {
        title: "macOS",
        desc: "Gateway를 위한 메뉴 막대 컴패니언 — 알림, 승인, 빠른 채팅.",
      },
      windows: {
        title: "Windows",
        desc: "Windows 컴패니언은 PC를 OpenClaw 노드로 연결합니다.",
      },
      linux: {
        title: "Linux",
  ...
  board: {
    ...
    widget: {
      cellLabel:
        "대시보드 위젯: {title}. 화살표 키로 이동하세요. Alt 키를 누른 채 화살표 키를 누르면 이동합니다.",
      moveHandle: "{title} 이동",
      ...
      frameAuthorizationFailed: "반복적인 새로 고침 시도 후에도 위젯 인증에 실패했습니다.",
  ...
  chat: {
    ...
    sessionHeader: {
      ...
      copied: "복사됨",
      branches: "스레드 분기",
      branchSwitchUnavailable: "에이전트가 작업하는 동안에는 분기를 전환할 수 없습니다.",
      branchSwitchRequiresAdmin: "분기 전환에는 운영자 관리자 액세스가 필요합니다.",
      untitledBranch: "제목 없는 브랜치",
    ...
    board: {
      ...
      reopenChat: "채팅 표시",
      defaultTab: "메인",
      mockPlaceholder: "보드 뷰 seam · 탭 {tabs}개 · 위젯 {widgets}개",
      mockOverview: "개요",
      mockResearch: "리서치",
    ...
    composer: {
      ...
      cameraPageInactive: "이 페이지가 비활성 상태일 때는 카메라를 사용할 수 없습니다.",
      ...
      holdToRecordSetting: "받아쓰기하려면 마이크 버튼을 누른 채로 유지",
      holdToRecordSettingDescription:
        "작성기의 마이크 버튼을 누른 채로 말한 다음 놓으면 전송하지 않고 텍스트가 삽입됩니다.",
      ...
      dictationConnecting: "받아쓰기 시작 중…",
      dictationDisconnected: "Gateway 연결이 끊겨 받아쓰기가 중지되었습니다.",
      dictationFailed: "받아쓰기에 실패했습니다.",
      dictationFinalizing: "받아쓰기 완료 중…",
      dictationFinalizationTimedOut:
        "마지막 부분 전사본을 완료하기 전에 받아쓰기가 중지되었습니다.",
      dictationProviderUnavailable: "받아쓰기에 사용할 전사 제공자가 구성되어 있지 않습니다.",
