...
export const uk: TranslationMap = {
  ...
  channels: {
    ...
    whatsapp: {
      ...
      logoutNotCleared:
        "Жодну збережену сесію WhatsApp не очищено. Можливо, її вже немає, або її каталог авторизації потребує ручного очищення.",
    },
  ...
  nodes: {
    pairing: {
      ...
      noApp: "Ще немає застосунку?",
      getApps: "Завантажити застосунки",
  ...
  agentChip: {
    ...
    offlineOpenSettings: "Не в мережі — відкрийте Налаштування",
  ...
  sessionsView: {
    ...
    global: "Глобально",
    unknown: "Невідомо",
    sessionState: "Стан потоку",
    viewArchived: "Переглянути архівовані",
    sessionArchived: "Потік архівовано",
    sessionsArchived: "Архівовано потоків: {count}",
    deleteAllArchived: "Видалити всі архівовані…",
    deleteAllArchivedConfirm: "Видалити {count} архівованих потоків та їхні транскрипти?",
    ...
    lastActive: "Востаннє активна {time}",
    surface: "Поверхня",
    subject: "Тема",
    room: "Кімната",
    space: "Простір",
    ...
    removeIcon: "Вилучити піктограму",
  ...
  configView: {
    ...
    notifications: {
      ...
      nativeBlockedHint:
        "Сповіщення вимкнено для OpenClaw у macOS. Дозвольте їх у Системних параметрах > Сповіщення.",
    },
    appearance: {
      theme: "Тема",
    ...
    sidebarPrefs: {
      title: "Бічна панель",
      hint: "Виберіть, що відображатиметься під час виконання сесій.",
      liveActivity: "Показувати активність агента в бічній панелі",
      liveActivityHint:
        "Показувати останню активність асистента чи інструмента під запущеними сесіями.",
    },
    connection: {
      title: "Підключення",
      gateway: "Gateway",
  ...
  execApproval: {
    ...
    reviewRequest: "Переглянути схвалення від {agent}: {command}",
  ...
  subtitles: {
    ...
    advanced: "Усі решта розділів конфігурації, а також редактор сирого файлу.",
  ...
  custodian: {
    title: "OpenClaw",
    subtitle: "Ваш посібник з налаштування системи",
    ...
    sessionRestarted:
      "{error} OpenClaw розпочав нову сесію; попередні повідомлення збережено для контексту.",
    unsupportedGateway: "Оновіть Gateway, щоб продовжити налаштування з OpenClaw.",
    history: {
      button: "Історія",
      title: "Останні зміни",
      description: "Що змінилося в цій системі, найновіше зверху.",
      loading: "Завантаження останніх змін…",
      empty: "Записаних змін поки немає.",
      requestFailed: "OpenClaw не вдалося завантажити історію змін.",
      ...
      opaqueChange: "Форматування або коментарі змінилися без видимих змін шляхів конфігурації.",
      sources: {
  ...
  mcpServers: {
    ...
    nameInvalid: "Назви серверів використовують літери, цифри, крапки, дефіси або підкреслення.",
    targetInvalid: "Введіть URL http(s) або командний рядок.",
    nameTaken: "MCP-сервер із назвою «{name}» вже існує.",
  ...
  labsPage: {
    ...
    sectionDescription:
      "Зміни зберігаються негайно та застосовуються до майбутніх запусків агента.",
    documentation: "Документація",
    restartRequired: "Потрібне перезавантаження Gateway.",
    ...
    swarm: {
      title: "Swarm",
      description: "Дозвольте Code Mode керувати групами субагентів паралельно.",
      empty: "Немає активних swarm.",
    },
  },
  aboutPage: {
  ...
  appsPage: {
    ...
    pairDevice: "Підключіть свій пристрій",
    ...
    badgeBundledIos: "Входить до складу застосунку для iOS",
    badgeBundledAndroid: "Входить до складу застосунку для Android",
    ...
    cards: {
      ...
      appleWatch: {
        title: "Apple Watch",
        desc: "Швидкий перегляд чатів і миттєві відповіді просто із зап'ястя.",
      },
      wearOs: {
        title: "Wear OS",
        desc: "Супутній застосунок Android розширює OpenClaw на ваш годинник.",
      },
      macos: {
        title: "macOS",
  ...
  profilePage: {
    ...
    identity: {
      ...
      profileUnavailable: "Не вдалося завантажити ваш профіль ідентичності.",
      avatar: "Аватар",
      ...
      linkedEmails: "Прив’язані електронні адреси",
  ...
  board: {
    ...
    emptyHint: "Ваш агент може закріплювати віджети тут — спробуйте попросити картку статусу.",
    ...
    widget: {
      ...
      actionErrorDetail: "Інформаційна панель зберегла попередній стан віджета.",
  ...
  chat: {
    ...
    board: {
      ...
      dockHidden: "Приховати чат",
      resizeDock: "Змінити розмір панелі чату",
      reopenChat: "Показати чат",
      defaultTab: "Головна",
      mockPlaceholder: "З’єднання вигляду дошки · {tabs} вкладок · {widgets} віджетів",
      mockOverview: "Огляд",
      mockResearch: "Дослідження",
      mockSessionStatus: "Статус гілки",
    ...
    questions: {
      ...
      eyebrow: "Питання",
      cardLabel: "Питання від асистента",
      summaryLabel: "Результат питання",
    ...
    composer: {
      ...
      cameraInput: "Камера",
      cameraListUnsupported: "Цей браузер не може перелічити камери.",
      ...
      microphoneAppliesNextSession: "Зміни набудуть чинності, коли ви почнете наступну сесію Talk.",
      ...
      holdToRecordSettingDescription:
        "Утримуйте кнопку мікрофона в редакторі, говоріть, потім відпустіть, щоб вставити текст без надсилання.",
      dictationAudioUnsupported: "Gateway повернув непідтримуваний формат аудіо для диктування.",
      dictationBrowserAudioUnsupported:
        "Цей браузер не може захоплювати аудіо диктування з частотою 8 кГц.",
      dictationConnecting: "Запуск диктування…",
      dictationDisconnected: "Диктування зупинено через відключення Gateway.",
      dictationFailed: "Не вдалося виконати диктування.",
      dictationFinalizing: "Завершення диктування…",
      dictationFinalizationTimedOut:
        "Диктування зупинено до того, як останній частковий транскрипт було завершено.",
      dictationProviderUnavailable:
        "Для диктування не налаштовано жодного провайдера транскрипції.",
