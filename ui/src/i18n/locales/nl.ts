...
export const nl: TranslationMap = {
  ...
  channels: {
    ...
    whatsapp: {
      ...
      loggedOut: "Afgemeld.",
      logoutNotCleared:
        "Er is geen opgeslagen WhatsApp-sessie gewist. Mogelijk is die al afwezig, of moet de auth-map handmatig worden opgeschoond.",
    },
  ...
  configView: {
    ...
    syncedHint: "Gesynchroniseerd over je apparaten via de Gateway.",
    notifications: {
      title: "Pushmeldingen",
      nativeTitle: "Meldingen",
      hint: "Ontvang browser-pushmeldingen van je gateway.",
      nativeHint: "Meldingen worden native getoond door de OpenClaw-app op deze Mac.",
    ...
    sidebarPrefs: {
      title: "Zijbalk",
      hint: "Kies wat er verschijnt terwijl sessies actief zijn.",
  ...
  execApproval: {
    ...
    reviewRequest: "Goedkeuring van {agent} beoordelen: {command}",
  ...
  subtitles: {
    ...
    custodian: "Systeeminstallatie en onderhoud.",
    ...
    labs: "Experimentele agent- en tool-mogelijkheden.",
    ...
    notifications: "Browser-pushmeldingen van je gateway.",
    security: "Gateway-authenticatie, exec-beleid, tool-profiel en goedkeuringen.",
  ...
  custodian: {
    ...
    subtitleCaretaker: "Systeeminstallatie en onderhoud.",
    ...
    history: {
      ...
      invalidEdit: "Deze handmatige bewerking is niet door de configuratievalidatie gekomen.",
      opaqueChange:
    ...
    nudge: {
      ...
      channelDisconnected: "{channel} is net losgekoppeld — vraag me wat er is gebeurd",
  ...
  labsPage: {
    intro:
      "Labs bevat experimentele mogelijkheden die tussen releases kunnen wijzigen, kapotgaan of verdwijnen.",
    sectionTitle: "Experimentele functies",
    sectionDescription:
      "Wijzigingen worden meteen opgeslagen en gelden voor toekomstige agentruns.",
  ...
  profilePage: {
    ...
    identity: {
      ...
      displayName: "Weergavenaam",
      displayNameDescription: "Getoond aan andere mensen die deze gateway gebruiken.",
      linkedEmails: "Gekoppelde e-mails",
      linkedEmailsDescription: "E-mailadressen die aan dit profiel zijn gekoppeld.",
      openSettings: "Identiteitsinstellingen openen voor {name}",
      avatarErrors: {
  ...
  board: {
    ...
    actionInProgress: "Een andere dashboardwijziging wordt nog opgeslagen.",
    announcement: {
      moved: "{title} verplaatst.",
      resized: "{title} van formaat gewijzigd.",
    ...
    widget: {
      ...
      resizeHandle: "{title} van formaat wijzigen",
      menuLabel: "Widgetopties",
      moveToTab: "Naar tabblad verplaatsen",
      ...
      errorDetail: "Het probleem beperkt zich tot deze kaart.",
      actionErrorTitle: "Widgetwijziging mislukt",
  ...
  chat: {
    ...
    sessionHeader: {
      ...
      branchSwitchUnavailable: "Vertakking wisselen is niet beschikbaar terwijl de agent bezig is.",
    ...
    board: {
      ...
      dockBottom: "Chat onder vastzetten",
      dockHidden: "Chat verbergen",
      resizeDock: "Chatpaneel vergroten/verkleinen",
      reopenChat: "Chat tonen",
      defaultTab: "Hoofd",
      mockPlaceholder: "Bordweergave-naad · {tabs} tabbladen · {widgets} widgets",
    ...
    questions: {
      ...
      summaryLabel: "Uitkomst van vraag",
    ...
    messages: {
      ...
      rewindUnavailable: "Terugspoelen is niet beschikbaar terwijl de agent werkt",
      forkUnavailable: "Vertakken is niet beschikbaar terwijl de agent werkt",
    ...
    composer: {
      ...
      holdToRecordSettingDescription:
        "Houd de microfoonknop in de composer ingedrukt, spreek en laat los om tekst in te voegen zonder te verzenden.",
      dictationAudioUnsupported:
        "De Gateway retourneerde een niet-ondersteund audioformaat voor dicteren.",
      ...
      dictationFinalizationTimedOut:
        "Dicteren gestopt voordat het laatste gedeeltelijke transcript kon worden voltooid.",
