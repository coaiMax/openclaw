...
export const pt_BR: TranslationMap = {
  ...
  channels: {
    ...
    whatsapp: {
      ...
      logoutNotCleared:
        "Nenhuma sessão do WhatsApp armazenada foi limpa. Ela pode já estar ausente, ou seu diretório de autenticação pode exigir limpeza manual.",
    },
  ...
  agentChip: {
    ...
    offlineOpenSettings: "Off-line — abrir Configurações",
  ...
  quickSettings: {
    ...
    personal: {
      ...
      profileHint:
        "JPEG, PNG ou WebP. As imagens são recortadas no centro e redimensionadas para 512px.",
  ...
  configView: {
    ...
    sidebarPrefs: {
      ...
      liveActivityHint:
        "Mostrar a atividade mais recente do assistente ou ferramenta abaixo das sessões em execução.",
    },
    connection: {
      title: "Conexão",
      gateway: "Gateway",
  ...
  custodian: {
    ...
    history: {
      ...
      description: "O que mudou neste sistema, do mais recente para o mais antigo.",
      ...
      invalidEdit: "Esta edição manual não passou na validação da configuração.",
      opaqueChange:
        "A formatação ou os comentários foram alterados sem mudanças visíveis no caminho da configuração.",
      sources: {
  ...
  labsPage: {
    intro:
      "O Labs contém recursos experimentais que podem mudar, quebrar ou desaparecer entre as versões.",
    sectionTitle: "Recursos experimentais",
    sectionDescription:
      "As alterações são salvas imediatamente e se aplicam às execuções futuras do agente.",
  ...
  appsPage: {
    ...
    heroTagline:
      "Aplicativos complementares para o seu celular, relógio, computador e navegador — além de plugins para ampliar o que o seu agente pode fazer.",
    sectionMobile: "No seu celular",
    havePhone: "Já tem o aplicativo?",
    pairDevice: "Parear seu dispositivo",
    sectionWatch: "No seu pulso",
    sectionDesktop: "No seu computador",
    ...
    cards: {
      ...
      wearOs: {
        title: "Wear OS",
        desc: "O companheiro Android estende o OpenClaw ao seu relógio.",
      },
      macos: {
        title: "macOS",
        desc: "Companheiro na barra de menus para seu Gateway — notificações, aprovações e chat rápido.",
      },
      windows: {
        title: "Windows",
        desc: "O aplicativo complementar do Windows conecta seu PC como um nó OpenClaw.",
      },
      linux: {
        title: "Linux",
        desc: "Aplicativo desktop nativo — versões .deb e AppImage.",
      },
      chrome: {
  ...
  profilePage: {
    ...
    identity: {
      ...
      profileUnavailable: "Não foi possível carregar o perfil da sua identidade.",
      avatar: "Avatar",
      avatarDescription:
      ...
      avatarErrors: {
        ...
        sourceTooLarge: "Escolha uma imagem de 10 MB ou menos.",
  ...
  chat: {
    ...
    sessionHeader: {
      ...
      branchSwitchUnavailable:
        "A troca de ramificação está indisponível enquanto o agente está trabalhando.",
    ...
    board: {
      ...
      mockSessionStatus: "Status da conversa",
    ...
    messages: {
      ...
      rewindUnavailable: "O retrocesso está indisponível enquanto o agente está trabalhando",
      forkUnavailable: "A bifurcação está indisponível enquanto o agente está trabalhando",
    ...
    composer: {
      ...
      holdToRecordSettingDescription:
        "Segure o botão do microfone no compositor, fale e solte para inserir o texto sem enviar.",
      ...
      dictationDisconnected: "O ditado foi interrompido porque o Gateway foi desconectado.",
