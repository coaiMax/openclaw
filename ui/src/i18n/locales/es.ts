...
export const es: TranslationMap = {
  ...
  channels: {
    ...
    whatsapp: {
      ...
      logoutNotCleared:
        "No se eliminó ninguna sesión de WhatsApp almacenada. Es posible que ya no exista o que su directorio de autenticación requiera una limpieza manual.",
    },
  ...
  sessionsView: {
    ...
    runFailedReason: "Falló la ejecución: {reason}",
  ...
  configView: {
    ...
    sidebarPrefs: {
      ...
      liveActivityHint:
        "Muestra la última actividad del asistente o herramienta bajo las sesiones en ejecución.",
    },
    connection: {
      title: "Conexión",
      gateway: "Gateway",
  ...
  subtitles: {
    ...
    custodian: "Configuración y cuidado del sistema.",
    ...
    security: "Autenticación de Gateway, política de exec, perfil de herramientas y aprobaciones.",
    advanced:
  ...
  custodian: {
    ...
    connectionChanged:
      "La conexión de Gateway cambió. Reintenta para continuar esta configuración.",
    sessionRestarted:
      "{error} OpenClaw inició una nueva sesión; los mensajes anteriores permanecen como contexto.",
    unsupportedGateway: "Actualiza el Gateway para continuar la configuración con OpenClaw.",
    history: {
      button: "Historial",
      title: "Cambios recientes",
      description: "Qué cambió en este sistema, más recientes primero.",
      ...
      opaqueChange:
        "Cambiaron el formato o los comentarios sin cambios visibles en las rutas de configuración.",
      sources: {
    ...
    nudge: {
      configReload: "Se detuvo la recarga de configuración — pregúntame qué pasó",
  ...
  appsPage: {
    ...
    heroTagline:
      "Aplicaciones complementarias para tu teléfono, reloj, escritorio y navegador, además de complementos para ampliar lo que tu agente puede hacer.",
    ...
    cards: {
      ...
      android: {
        title: "Android",
        desc: "Tu teléfono Android como un nodo OpenClaw completo: chat, cámara y Canvas.",
      },
      appleWatch: {
        title: "Apple Watch",
        desc: "Chats a un vistazo y respuestas rápidas desde tu muñeca.",
      },
      wearOs: {
        title: "Wear OS",
      ...
      windows: {
        title: "Windows",
        desc: "El complemento de Windows conecta tu PC como un nodo OpenClaw.",
      },
      linux: {
        title: "Linux",
  ...
  board: {
    ...
    widget: {
      ...
      resizeHandle: "Cambiar tamaño de {title}",
      ...
      errorDetail: "El problema está limitado a esta tarjeta.",
  ...
  chat: {
    ...
    questions: {
      ...
      answered: "Respondido",
      answeredElsewhere: "Respondido en otro lugar",
      unavailable: "No disponible",
      expired: "Caducado",
      cancelled: "Cancelado",
    },
    messages: {
      ...
      hide: "Ocultar",
      hideConfirm: "¿Ocultar este mensaje en este navegador? El agente aún lo ve.",
    ...
    composer: {
      ...
      holdToRecordSettingDescription:
        "Mantén pulsado el botón del micrófono del editor, habla y luego suelta para insertar texto sin enviarlo.",
      ...
      dictationFinalizationTimedOut:
        "El dictado se detuvo antes de que se pudiera finalizar la última transcripción parcial.",
