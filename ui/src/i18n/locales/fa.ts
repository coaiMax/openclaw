...
export const fa: TranslationMap = {
  ...
  channels: {
    ...
    whatsapp: {
      ...
      loggedOut: "خارج شد.",
      logoutNotCleared:
        "هیچ نشست ذخیره‌شده WhatsApp پاک نشد. ممکن است از قبل وجود نداشته باشد یا پوشه احراز هویت آن نیاز به پاک‌سازی دستی داشته باشد.",
    },
  ...
  quickSettings: {
    ...
    personal: {
      ...
      profileHint:
        "JPEG، PNG یا WebP. تصاویر از مرکز برش داده و به ۵۱۲ پیکسل تغییر اندازه می‌یابند.",
  ...
  configView: {
    ...
    syncedHint: "همگام‌سازی‌شده در بین دستگاه‌های شما از طریق gateway.",
    notifications: {
      ...
      openSystemSettings: "باز کردن System Settings",
      blockedHint:
    ...
    sidebarPrefs: {
      ...
      liveActivityHint: "نمایش آخرین فعالیت دستیار یا ابزار در زیر نشست‌های در حال اجرا.",
    },
    connection: {
      title: "اتصال",
      gateway: "Gateway",
  ...
  subtitles: {
    ...
    security: "احراز هویت Gateway، خط‌مشی اجرا، نمایه ابزار و تأییدها.",
  ...
  custodian: {
    ...
    history: {
      button: "تاریخچه",
      title: "تغییرات اخیر",
      description: "چه چیزی در این سیستم تغییر کرد، جدیدترین در ابتدا.",
      ...
      opaqueChange: "قالب‌بندی یا نظرها بدون تغییرات قابل‌مشاهده در مسیر پیکربندی تغییر کردند.",
      sources: {
    ...
    nudge: {
      ...
      channelDisconnected: "{channel} همین حالا قطع شد — از من بپرسید چه اتفاقی افتاد",
      channelDegraded: "{channel} تضعیف شده است — از من بپرسید چه اتفاقی افتاد",
      channelFallback: "یک کانال",
      dismiss: "این به‌روزرسانی را رد کنید",
    },
  },
  mcpServers: {
    add: "افزودن سرور",
    ...
    configUnavailable: "پیکربندی در دسترس نیست؛ بازخوانی کنید و دوباره تلاش کنید.",
  ...
  labsPage: {
    ...
    sectionDescription: "تغییرات بلافاصله ذخیره می‌شوند و بر اجراهای آینده عامل اعمال می‌شوند.",
    documentation: "مستندات",
    restartRequired: "راه‌اندازی مجدد Gateway لازم است.",
    saveErrorTitle: "قابلیت به‌روزرسانی نشد",
    saveFailed: "تنظیمات قابلیت ذخیره نشد.",
    codeMode: {
      title: "حالت کد",
      description:
        "به عامل‌ها اجازه دهید ابزارها را در گردش‌کارهای فشرده و ایزوله‌ی JavaScript ترکیب کنند.",
    },
    swarm: {
      title: "Swarm",
  ...
  appsPage: {
    ...
    heroTagline:
      "اپلیکیشن‌های همراه برای گوشی، ساعت، دسکتاپ و مرورگر شما — به‌همراه افزونه‌هایی برای گسترش توانایی‌های عامل شما.",
    sectionMobile: "روی گوشی شما",
    havePhone: "همین حالا اپ را دارید؟",
    ...
    badgeBundledIos: "همراه با اپ iOS ارائه می‌شود",
    ...
    cards: {
      ios: {
        title: "iPhone",
        desc: "از iOS گفتگو کنید، صحبت کنید، اقدامات را تأیید کنید و به OpenClaw به اشتراک بگذارید.",
      },
      android: {
        title: "Android",
        desc: "گوشی Android شما به‌عنوان یک نود کامل OpenClaw — گفتگو، دوربین و Canvas.",
      },
      appleWatch: {
        title: "Apple Watch",
        desc: "گفتگوهای قابل مشاهده در یک نگاه و پاسخ‌های سریع از روی مچ دست شما.",
      },
      wearOs: {
        title: "Wear OS",
      ...
      windows: {
        title: "Windows",
        desc: "همراه Windows، رایانه شخصی شما را به‌عنوان یک نود OpenClaw متصل می‌کند.",
      },
      linux: {
        title: "Linux",
        desc: "برنامه بومی دسکتاپ — بیلدهای .deb و AppImage.",
      },
      chrome: {
        title: "افزونه Chrome",
        desc: "به OpenClaw اجازه دهید Chrome موجود شما را هدایت کند — برگه‌ها، صفحات و فرم‌ها.",
      },
      plugins: {
  ...
  profilePage: {
    ...
    identity: {
      ...
      displayName: "نام نمایشی",
      displayNameDescription: "برای افراد دیگری که از این gateway استفاده می‌کنند نمایش داده می‌شود.",
      ...
      avatarErrors: {
        invalid: "آن تصویر قابل پردازش نبود.",
  ...
  board: {
    ...
    announcement: {
      ...
      granted: "دسترسی ابزارک مجاز شد.",
      rejected: "دسترسی ابزارک رد شد.",
    },
    widget: {
      cellLabel:
        "ابزارک داشبورد: {title}. برای پیمایش از کلیدهای جهت‌نما استفاده کنید. برای جابه‌جایی، Alt را نگه دارید و یک کلید جهت‌نما را فشار دهید.",
      ...
      rejectedDetail: "این ویجت تا زمانی که حذف یا جایگزین شود غیرفعال باقی می‌ماند.",
      frameResolverMissing: "محتوای ویجت در دسترس نیست.",
      frameAuthorizationFailed: "احراز هویت ویجت پس از تلاش‌های مکرر برای بازخوانی ناموفق بود.",
      errorTitle: "این ویجت بارگذاری نشد",
      errorDetail: "مشکل تنها به این کارت محدود است.",
  ...
  chat: {
    ...
    sessionHeader: {
      ...
      branchSwitchUnavailable: "تعویض شاخه هنگام کار عامل در دسترس نیست.",
      branchSwitchRequiresAdmin: "تعویض شاخه نیازمند دسترسی ادمین اپراتور است.",
    ...
    messages: {
      ...
      rewind: "بازگردانی",
      rewindConfirm: "بازگردانی به قبل از این پیام؟",
      rewindToHere: "بازگردانی به اینجا",
      rewindUnavailable: "بازگردانی در حین کار عامل در دسترس نیست",
    ...
    modelControls: {
      ...
      reasoning: "استدلال",
      speed: "سرعت",
      sessionOverride: "بازنویسی گفتگو",
    ...
    composer: {
      ...
      cameraPageInactive: "دوربین‌ها در حالی که این صفحه غیرفعال است در دسترس نیستند.",
      ...
      holdToRecordSettingDescription:
        "دکمه میکروفون نگارنده را نگه دارید، صحبت کنید، سپس رها کنید تا متن بدون ارسال درج شود.",
      dictationAudioUnsupported: "Gateway یک قالب صوتی دیکته پشتیبانی‌نشده بازگرداند.",
      dictationBrowserAudioUnsupported: "این مرورگر نمی‌تواند صوت دیکته را با ۸ کیلوهرتز ضبط کند.",
      ...
      dictationFinalizing: "در حال تکمیل دیکته…",
      dictationFinalizationTimedOut: "دیکته پیش از نهایی شدن آخرین بخش رونوشت متوقف شد.",
    ...
    toolCards: {
      ...
      widgetExportRerender: "این ویجت باید دوباره رندر شود تا به‌صورت تصویر خروجی گرفته شود.",
      widgetExportFailed: "خروجی‌گیری ویجت ناموفق بود. دوباره تلاش کنید.",
    ...
    sessionDiscussion: {
      ...
      openExternal: "باز کردن گفت‌وگو در برگه‌ای جدید",
