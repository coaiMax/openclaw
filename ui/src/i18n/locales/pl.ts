...
export const pl: TranslationMap = {
  ...
  sessionsView: {
    ...
    customEmoji: "Własne emoji",
    invalidEmojiIcon: "Wpisz dokładnie jedno emoji.",
  ...
  configView: {
    ...
    sidebarPrefs: {
      title: "Pasek boczny",
      hint: "Wybierz, co ma się pojawiać podczas działających sesji.",
      liveActivity: "Pokazuj aktywność agenta na żywo w pasku bocznym",
      liveActivityHint:
        "Pokazuj najnowszą aktywność asystenta lub narzędzia pod działającymi sesjami.",
    },
    connection: {
      title: "Połączenie",
      gateway: "Gateway",
  ...
  subtitles: {
    ...
    labs: "Eksperymentalne możliwości agenta i narzędzi.",
  ...
  custodian: {
    title: "OpenClaw",
    subtitle: "Twój przewodnik konfiguracji systemu",
    subtitleCaretaker: "Konfiguracja i opieka nad systemem.",
    ...
    history: {
      ...
      description: "Co zmieniło się w tym systemie, najnowsze na górze.",
  ...
  labsPage: {
    ...
    codeMode: {
      title: "Tryb kodu",
      description:
        "Pozwól agentom łączyć narzędzia w kompaktowych, izolowanych workflow JavaScript.",
    },
    swarm: {
      title: "Swarm",
      description: "Pozwól trybowi kodu orkiestrować grupy podagentów równolegle.",
  ...
  appsPage: {
    ...
    heroTagline:
      "Aplikacje towarzyszące na telefon, zegarek, komputer i przeglądarkę — a także wtyczki rozszerzające możliwości Twojego agenta.",
    ...
    cards: {
      ...
      windows: {
        title: "Windows",
        desc: "Aplikacja towarzysząca na Windows łączy Twój komputer jako węzeł OpenClaw.",
      },
      linux: {
        title: "Linux",
  ...
  profilePage: {
    ...
    identity: {
      ...
      avatar: "Awatar",
      avatarDescription: "PNG, JPEG lub WebP. Obrazy są skalowane do 256 × 256 lub mniej.",
  ...
  board: {
    ...
    emptyHint: "Twój agent może przypinać tu widżety — spróbuj poprosić o kartę statusu.",
    actionFailed: "Nie udało się zapisać zmiany panelu.",
    actionInProgress: "Trwa jeszcze zapisywanie innej zmiany panelu.",
    announcement: {
    ...
    widget: {
      cellLabel:
        "Widżet panelu: {title}. Użyj klawiszy strzałek, aby nawigować. Przytrzymaj Alt i naciśnij strzałkę, aby go przenieść.",
  ...
  chat: {
    ...
    board: {
      ...
      defaultTab: "Główny",
      mockPlaceholder: "Szew widoku tablicy · {tabs} kart · {widgets} widżetów",
      ...
      resetDescription: "Kontekst rozmowy zostanie zresetowany. Panel pozostanie.",
    },
    catalog: {
    ...
    modelControls: {
      ...
      usingDefault: "Używane są ustawienia domyślne z Ustawień",
    ...
    composer: {
      ...
      holdToRecordSettingDescription:
        "Przytrzymaj przycisk mikrofonu w polu tworzenia wiadomości, mów, a następnie zwolnij, aby wstawić tekst bez wysyłania.",
      dictationAudioUnsupported: "Gateway zwrócił nieobsługiwany format dźwięku dyktowania.",
      dictationBrowserAudioUnsupported:
        "Ta przeglądarka nie może przechwytywać dźwięku dyktowania przy 8 kHz.",
      ...
      dictationFinalizationTimedOut:
        "Dyktowanie zostało zatrzymane, zanim ostatni fragment transkrypcji mógł zostać sfinalizowany.",
