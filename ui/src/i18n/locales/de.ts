...
export const de: TranslationMap = {
  ...
  channels: {
    ...
    whatsapp: {
      ...
      logoutNotCleared:
        "Es wurde keine gespeicherte WhatsApp-Sitzung gelöscht. Möglicherweise ist sie bereits nicht mehr vorhanden, oder ihr Auth-Verzeichnis muss manuell bereinigt werden.",
    },
  ...
  newSession: {
    ...
    cloudRequiresOpenClawRuntime:
      "Cloud-Worker erfordern die OpenClaw-Runtime; {runtime} ist ausgewählt.",
  ...
  sessionsView: {
    ...
    attentionRequired: "Sitzung erfordert Aufmerksamkeit",
    model: "Modell",
    provider: "Anbieter",
    runtime: "Laufzeit",
  ...
  configView: {
    ...
    syncedHint: "Über das Gateway auf all Ihren Geräten synchronisiert.",
    notifications: {
    ...
    sidebarPrefs: {
      title: "Seitenleiste",
      hint: "Wählen Sie aus, was während laufender Sitzungen angezeigt wird.",
      liveActivity: "Live-Aktivität des Agenten in der Seitenleiste anzeigen",
      liveActivityHint:
  ...
  subtitles: {
    ...
    labs: "Experimentelle Agenten- und Werkzeugfunktionen.",
    ...
    security: "Gateway-Authentifizierung, Exec-Richtlinie, Werkzeugprofil und Freigaben.",
    advanced: "Alle verbleibenden Konfigurationsbereiche sowie der Roh-Dateieditor.",
  ...
  custodian: {
    ...
    history: {
      ...
      invalidEdit: "Diese manuelle Bearbeitung hat die Konfigurationsvalidierung nicht bestanden.",
      opaqueChange:
        "Formatierung oder Kommentare wurden ohne sichtbare Änderungen am Konfigurationspfad geändert.",
      sources: {
  ...
  mcpServers: {
    ...
    adminRequired: "MCP-Server-Änderungen erfordern operator.admin-Zugriff.",
  ...
  labsPage: {
    ...
    restartRequired: "Neustart des Gateway erforderlich.",
    ...
    codeMode: {
      title: "Code Mode",
      description:
        "Lassen Sie Agenten Tools in kompakten, gesandboxten JavaScript-Workflows kombinieren.",
    },
    swarm: {
      title: "Swarm",
  ...
  appsPage: {
    ...
    badgeBundledIos: "Im iOS-App enthalten",
    ...
    cards: {
      ...
      android: {
        title: "Android",
        desc: "Dein Android-Telefon als vollwertiger OpenClaw-Node – Chat, Kamera und Canvas.",
      },
      appleWatch: {
        title: "Apple Watch",
        desc: "Chats auf einen Blick und schnelle Antworten von deinem Handgelenk.",
      },
      wearOs: {
        title: "Wear OS",
      ...
      windows: {
        title: "Windows",
        desc: "Der Windows-Begleiter verbindet deinen PC als OpenClaw-Knoten.",
      },
      linux: {
        title: "Linux",
  ...
  profilePage: {
    ...
    identity: {
      title: "Identität",
      description: "Dein Profil auf diesem Gateway.",
      loading: "Deine Identität wird geladen…",
      profileUnavailable: "Dein Identitätsprofil konnte nicht geladen werden.",
      avatar: "Avatar",
      ...
      displayName: "Anzeigename",
      displayNameDescription: "Wird anderen Personen angezeigt, die dieses Gateway verwenden.",
      ...
      avatarErrors: {
        ...
        sourceTooLarge: "Wählen Sie ein Bild mit maximal 10 MB.",
  ...
  board: {
    ...
    widget: {
      ...
      frameAuthorizationFailed:
        "Widget-Autorisierung nach wiederholten Aktualisierungsversuchen fehlgeschlagen.",
  ...
  chat: {
    ...
    sessionHeader: {
      ...
      branchSwitchRequiresAdmin: "Der Verzweigungswechsel erfordert Operator-Admin-Zugriff.",
    ...
    board: {
      ...
      resizeDock: "Chat-Dock skalieren",
      ...
      resetDescription:
        "Der Unterhaltungskontext wird zurückgesetzt. Ihr Dashboard bleibt erhalten.",
    },
    catalog: {
      remoteViewOnly:
    ...
    messages: {
      ...
      rewind: "Zurückspulen",
      rewindConfirm: "Zu vor dieser Nachricht zurückspulen?",
    ...
    composer: {
      ...
      holdToRecordSetting: "Mikrofonschaltfläche gedrückt halten zum Diktieren",
      holdToRecordSettingDescription:
        "Halte die Mikrofonschaltfläche des Editors gedrückt, sprich und lasse sie dann los, um Text einzufügen, ohne ihn zu senden.",
      ...
      dictationDisconnected: "Diktat gestoppt, weil das Gateway die Verbindung getrennt hat.",
      dictationFailed: "Diktat fehlgeschlagen.",
      dictationFinalizing: "Diktat wird abgeschlossen…",
      dictationFinalizationTimedOut:
        "Diktat wurde gestoppt, bevor das letzte Teiltranskript finalisiert werden konnte.",
      ...
      selectedCameraUnavailable:
        "Die ausgewählte Kamera ist nicht verfügbar. Wähle eine andere Kamera oder die Systemstandardeinstellung.",
