...
export const ja_JP: TranslationMap = {
  ...
  channels: {
    ...
    whatsapp: {
      ...
      loggedOut: "ログアウトしました。",
      logoutNotCleared:
        "保存されたWhatsAppセッションは消去されませんでした。すでに存在しないか、認証ディレクトリを手動でクリーンアップする必要がある可能性があります。",
    },
  ...
  sessionsView: {
    ...
    deleteAllArchived: "すべてのアーカイブを削除…",
  ...
  quickSettings: {
    ...
    personal: {
      ...
      profileIdentity: "あなたのGatewayプロフィール",
      ...
      saving: "保存中…",
      uploading: "処理中…",
      profileHint: "JPEG、PNG、またはWebP。画像は中央を切り抜き、512pxにリサイズされます。",
  ...
  configView: {
    ...
    notifications: {
      ...
      nativeHint: "この Mac の OpenClaw アプリによって通知がネイティブに表示されます。",
    ...
    sidebarPrefs: {
      ...
      liveActivity: "サイドバーにエージェントのライブアクティビティを表示",
      liveActivityHint:
        "実行中のセッションの下に最新のアシスタントまたはツールのアクティビティを表示します。",
    },
    connection: {
      title: "接続",
      gateway: "Gateway",
  ...
  custodian: {
    ...
    earlier: "以前",
    requestFailed: "OpenClaw が応答できませんでした。もう一度お試しください。",
    connectionChanged:
      "Gateway 接続が変更されました。このセットアップを続けるには再試行してください。",
    sessionRestarted:
      "{error} OpenClaw は新しいセッションを開始しました。以前のメッセージはコンテキストとして保持されます。",
    unsupportedGateway: "OpenClaw でセットアップを続けるには Gateway を更新してください。",
    history: {
      button: "履歴",
      title: "最近の変更",
      description: "このシステムで変更された内容を、新しい順に表示します。",
      loading: "最近の変更を読み込んでいます…",
  ...
  mcpServers: {
    ...
    targetInvalid: "http(s) URL またはコマンドラインを入力してください。",
    nameTaken: "「{name}」という名前の MCP サーバーはすでに存在します。",
    ...
    configUnavailable: "構成を利用できません。再読み込みして再試行してください。",
  ...
  labsPage: {
    ...
    saveFailed: "機能の設定を保存できませんでした。",
    codeMode: {
      title: "コードモード",
      description:
        "エージェントがコンパクトでサンドボックス化された JavaScript ワークフローでツールを組み合わせられるようにします。",
    },
    swarm: {
      title: "Swarm",
      description: "コードモードがサブエージェントのグループを並列に編成できるようにします。",
  ...
  appsPage: {
    ...
    heroTagline:
      "スマートフォン、ウォッチ、デスクトップ、ブラウザ向けのコンパニオンアプリに加え、エージェントの機能を拡張するプラグインもご用意しています。",
    ...
    badgeBundledAndroid: "Android アプリに付属",
    ...
    cards: {
      ...
      android: {
        title: "Android",
        desc: "Android スマートフォンを完全な OpenClaw ノードとして活用 — チャット、カメラ、Canvas。",
      },
      appleWatch: {
        title: "Apple Watch",
        desc: "手元で一目で確認できるチャットとクイック返信。",
      },
      wearOs: {
        title: "Wear OS",
        desc: "Android コンパニオンが OpenClaw を時計まで拡張します。",
      },
      macos: {
        title: "macOS",
      ...
      plugins: {
        title: "プラグイン & ClawHub",
        desc: "コミュニティのチャネル、ツール、Skills で OpenClaw を拡張します。",
      },
    },
  },
  presence: {
  ...
  profilePage: {
    ...
    identity: {
      title: "アイデンティティ",
      description: "この Gateway 上のあなたのプロフィール。",
  ...
  board: {
    ...
    emptyTitle: "作業を始められる、すっきりしたボード",
    emptyHint:
      "エージェントはここにウィジェットをピン留めできます — ステータスカードをリクエストしてみてください。",
    ...
    announcement: {
      ...
      granted: "ウィジェットのアクセスを許可しました。",
      rejected: "ウィジェットのアクセスを拒否しました。",
    },
    widget: {
      cellLabel:
      ...
      frameAuthorizationFailed: "更新を繰り返し試みた後もウィジェットの承認に失敗しました。",
  ...
  chat: {
    ...
    sessionHeader: {
      ...
      branchSwitchRequiresAdmin: "ブランチの切り替えにはオペレーターの管理者アクセスが必要です。",
    ...
    board: {
      ...
      reopenChat: "チャットを表示",
      defaultTab: "メイン",
      mockPlaceholder: "ボードビューのシーム · {tabs} タブ · {widgets} ウィジェット",
      mockOverview: "概要",
      mockResearch: "リサーチ",
      mockSessionStatus: "スレッドの状態",
    ...
    modelControls: {
      ...
      usingDefault: "設定の既定値を使用中",
      resetToDefault: "既定値にリセット（{model}）",
    },
    sideChat: {
      title: "サイドチャット",
    ...
    composer: {
      ...
      cameraInput: "カメラ",
      cameraListUnsupported: "このブラウザーはカメラの一覧を表示できません。",
      ...
      holdToRecordSetting: "マイクボタンを押し続けて音声入力",
      holdToRecordSettingDescription:
        "コンポーザーのマイクボタンを押しながら話し、離すと送信せずにテキストを挿入します。",
      dictationAudioUnsupported: "Gatewayがサポートされていない音声入力の音声形式を返しました。",
      dictationBrowserAudioUnsupported: "このブラウザーは8 kHzで音声入力の音声を取得できません。",
      dictationConnecting: "音声入力を開始しています…",
      dictationDisconnected: "Gatewayが切断されたため音声入力を停止しました。",
      dictationFailed: "音声入力に失敗しました。",
      dictationFinalizing: "音声入力を完了しています…",
      dictationFinalizationTimedOut: "最後の暫定テキストを確定する前に音声入力が停止しました。",
      dictationProviderUnavailable: "音声入力用の文字起こしプロバイダーが設定されていません。",
      dictationRecording: "録音中 {elapsed}",
      dictationReleaseToInsert: "離すと音声入力を挿入します",
