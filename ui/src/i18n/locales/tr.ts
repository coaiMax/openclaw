...
export const tr: TranslationMap = {
  ...
  channels: {
    ...
    whatsapp: {
      ...
      logoutNotCleared:
        "Kayıtlı bir WhatsApp oturumu temizlenmedi. Zaten yok olabilir veya kimlik doğrulama dizini manuel temizlik gerektirebilir.",
    },
  ...
  nodes: {
    pairing: {
      ...
      noApp: "Uygulama sizde henüz yok mu?",
  ...
  sessionsView: {
    ...
    dashboardAvailable: "Pano mevcut",
    ...
    attentionRequired: "Oturum ilgilenilmesi gerekiyor",
    model: "Model",
    provider: "Sağlayıcı",
  ...
  quickSettings: {
    ...
    personal: {
      ...
      saving: "Kaydediliyor…",
      uploading: "İşleniyor…",
      profileHint: "JPEG, PNG veya WebP. Görüntüler ortadan kırpılır ve 512px boyutuna getirilir.",
  ...
  configView: {
    ...
    notifications: {
      ...
      nativeBlockedHint:
        "macOS'ta OpenClaw için bildirimler devre dışı. Sistem Ayarları > Bildirimler bölümünden izin verin.",
    },
    appearance: {
      theme: "Tema",
    ...
    sidebarPrefs: {
      ...
      liveActivity: "Kenar çubuğunda canlı ajan etkinliğini göster",
      liveActivityHint:
  ...
  execApproval: {
    ...
    reviewRequest: "{agent} tarafından onayı inceleyin: {command}",
  ...
  subtitles: {
    ...
    security: "Gateway kimlik doğrulama, yürütme ilkesi, araç profili ve onaylar.",
  ...
  custodian: {
    ...
    sessionRestarted:
      "{error} OpenClaw yeni bir oturum başlattı; önceki mesajlar bağlam için kalır.",
    unsupportedGateway: "OpenClaw ile kuruluma devam etmek için Gateway'i güncelleyin.",
    history: {
      button: "Geçmiş",
      title: "Son değişiklikler",
      description: "Bu sistemde neler değişti, en yeni en üstte.",
    ...
    nudge: {
      configReload: "Yapılandırma yeniden yüklemesi durdu — bana ne olduğunu sorun",
      channelAuth: "{channel} kimlik doğrulaması bozuldu — bana ne olduğunu sorun",
      channelDisconnected: "{channel} az önce bağlantısı kesildi — bana ne olduğunu sorun",
  ...
  mcpServers: {
    ...
    missing: "Yapılandırmada “{name}” MCP sunucusu bulunamadı.",
    ...
    adminRequired: "MCP sunucu değişiklikleri operator.admin erişimi gerektirir.",
  ...
  mcpPage: {
    connectorsLink: "Tek tıkla bağlanan konnektörleri Eklentiler sayfasında keşfedin.",
    servers: "Sunucular",
    oauth: "OAuth",
  ...
  sessionsPage: {
    hubTablistLabel: "Konu bölümleri",
  },
  pluginsPage: {
  ...
  labsPage: {
    ...
    restartRequired: "Gateway yeniden başlatma gerekli.",
    saveErrorTitle: "Özellik güncellenemedi",
    saveFailed: "Özellik ayarı kaydedilemedi.",
    codeMode: {
      title: "Kod Modu",
      description:
        "Aracıların araçları kompakt, yalıtılmış JavaScript iş akışlarında birleştirmesine izin verin.",
    },
    swarm: {
      title: "Swarm",
      description: "Kod Modu'nun alt aracı gruplarını paralel olarak düzenlemesine izin verin.",
  ...
  appsPage: {
    ...
    havePhone: "Uygulama zaten sizde mi?",
    ...
    cards: {
      ...
      appleWatch: {
        title: "Apple Watch",
        desc: "Bileğinizden hızlı bakışlı sohbetler ve hızlı yanıtlar.",
      },
      wearOs: {
        title: "Wear OS",
        desc: "Android yardımcı uygulaması OpenClaw'u saatinize taşır.",
      },
      macos: {
        title: "macOS",
      ...
      plugins: {
        ...
        desc: "OpenClaw'ı topluluktan kanallar, araçlar ve Skills ile genişletin.",
      },
    },
  },
  presence: {
  ...
  board: {
    ...
    emptyHint: "Aracınız buraya bileşen sabitleyebilir — bir durum kartı isteyin.",
    ...
    widget: {
      ...
      errorDetail: "Sorun bu kartla sınırlı.",
  ...
  chat: {
    ...
    sessionHeader: {
      ...
      branchSwitchUnavailable: "Aracı çalışırken dal değiştirme kullanılamaz.",
      branchSwitchRequiresAdmin: "Dal değiştirme için operatör yönetici erişimi gerekir.",
    ...
    messages: {
      ...
      rewind: "Geri sar",
      rewindConfirm: "Bu mesajın öncesine geri sarılsın mı?",
    ...
    composer: {
      ...
      holdToRecordSettingDescription:
        "Yazma alanındaki mikrofon düğmesini basılı tutun, konuşun, ardından göndermeden metin eklemek için bırakın.",
      dictationAudioUnsupported: "Gateway desteklenmeyen bir dikte ses formatı döndürdü.",
      dictationBrowserAudioUnsupported: "Bu tarayıcı dikte sesini 8 kHz'de yakalayamıyor.",
      ...
      dictationFinalizationTimedOut: "Son kısmi transkript tamamlanmadan dikte durduruldu.",
    ...
    sessionDiscussion: {
      ...
      unavailable: "Bu tartışma yerleştirilemiyor.",
    },
    workspaceFiles: {
