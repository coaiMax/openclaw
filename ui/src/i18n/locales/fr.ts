...
export const fr: TranslationMap = {
  ...
  configView: {
    ...
    sidebarPrefs: {
      ...
      liveActivity: "Afficher l'activité de l'agent en direct dans la barre latérale",
      liveActivityHint:
  ...
  subtitles: {
    ...
    security: "Authentification Gateway, politique d'exécution, profil d'outils et approbations.",
    advanced: "Toutes les autres sections de configuration, plus l'éditeur de fichier brut.",
  ...
  custodian: {
    ...
    placeholder: "Message à OpenClaw…",
    ...
    connectionChanged:
      "La connexion Gateway a changé. Réessayez pour poursuivre cette configuration.",
    sessionRestarted:
    ...
    history: {
      ...
      opaqueChange:
        "Le formatage ou les commentaires ont changé sans modification visible des chemins de configuration.",
      sources: {
    ...
    nudge: {
      ...
      channelAuth: "L'authentification de {channel} est dégradée — demandez-moi ce qui s'est passé",
  ...
  sessionsPage: {
    hubTablistLabel: "Sections des fils",
  },
  pluginsPage: {
  ...
  labsPage: {
    intro:
      "Labs contient des fonctionnalités expérimentales susceptibles de changer, de cesser de fonctionner ou de disparaître entre les versions.",
  ...
  profilePage: {
    ...
    identity: {
      ...
      displayName: "Nom d'affichage",
      displayNameDescription: "Affiché aux autres personnes qui utilisent ce gateway.",
  ...
  board: {
    ...
    widget: {
      ...
      rejectedDetail: "Ce widget reste inactif tant qu'il n'est pas supprimé ou remplacé.",
  ...
  chat: {
    ...
    board: {
      ...
      dockMenu: "Ancrage de la discussion : {dock}",
      dockLeft: "Ancrer la discussion à gauche",
      ...
      mockPlaceholder: "Aperçu du tableau · {tabs} onglets · {widgets} widgets",
      mockOverview: "Aperçu",
    ...
    composer: {
      ...
      holdToRecordSetting: "Maintenez le bouton du microphone pour dicter",
      holdToRecordSettingDescription:
        "Maintenez le bouton du microphone du compositeur, parlez, puis relâchez pour insérer le texte sans l'envoyer.",
      ...
      dictationFinalizing: "Fin de la dictée…",
      ...
      selectedCameraUnavailable:
        "La caméra sélectionnée est indisponible. Choisissez une autre caméra ou la valeur par défaut du système.",
    ...
    toolCards: {
      ...
      widgetExportFailed: "L'exportation du widget a échoué. Réessayez.",
    ...
    sessionDiscussion: {
      ...
      opened: "Discussion de la session",
